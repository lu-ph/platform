  ...
  return (
    <div className="min-h-screen bg-[#FDFBF7] flex items-center justify-center text-[#333]">
      <div className="bg-white p-8 rounded-xl shadow-sm border border-[#EFECE6] w-full max-w-sm">
        <h1 className="text-xl font-medium mb-6 text-center text-[#5C5549]">
          管理员登录
        </h1>
        ...
        <form action={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              name="username"
              required
              className="w-full px-3 py-2 border border-[#E5E1D8] rounded-md focus:outline-none focus:border-[#C4B7A6] bg-[#FDFBF7]"
            />
          </div>
          <div>
            <label className="block text-xs font-medium text-[#7C7569] mb-1">
          ...
          <button
            type="submit"
            className="w-full bg-[#5C5549] text-white py-2 rounded-md hover:bg-[#4A443A] transition text-sm"
          >
            登 录
          </button>
        </form>
